...
$query_af4 = "SELECT * FROM regi ORDER BY rank ASC";
$query1= "select count(*)                         as total
  ...
  from regi";
$af4 = mysql_query($query_af4, $MyConnection2) or die(mysql_error());
$row_af4 = mysql_fetch_assoc($af4);
$totalRows_af4 = mysql_num_rows($af4);
?>
