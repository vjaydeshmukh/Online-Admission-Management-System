...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "widgetu7489")) {
  $updateSQL = sprintf("UPDATE regi SET branch1=%s, branch2=%s WHERE Roll_12=%s",
...
if(typeof Muse == "undefined") window.Muse = {}; window.Muse.assets = {"required":["museutils.js", "museconfig.js", "jquery.watch.js", "webpro.js", "require.js", "jquery.musepolyfill.bgsize.js", "choice.css"], "outOfDate":[]};
</script>
  ...
  <link rel="stylesheet" type="text/css" href="css/choice.css?crc=250778225" id="pagesheet"/>
  <!-- JS includes -->
  <!--[if lt IE 9]>
 ...
 <body>
  ...
  <div class="clearfix borderbox" id="page"><!-- column -->
   ...
   <div class="rounded-corners clearfix colelem" id="u7909"><!-- group -->
    <div class="clearfix grpelem" id="u7925-6"><!-- content -->
     <p>COUNSELLING&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="adf.php">ADMIN</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="f1.php">INFORMATION</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="nonblock" href="<?php echo $logoutAction ?>"> LOGOUT</a></p>
    </div>
   </div>
   <div><p><br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Welcome Roll No : 
   <?php 
 print_r ($_SESSION['MM_Username']);
 $a=$_SESSION['MM_Username'];
 $sql = "SELECT regi.Candidate_Name FROM regi WHERE Roll_12 = '" . $_SESSION['MM_Username'] . "'";
 $sql1 = "SELECT regi.rank FROM regi WHERE Roll_12 = '" . $_SESSION['MM_Username'] . "'";
 $sql2 = "SELECT regi.branch1 FROM regi WHERE Roll_12 = '" . $_SESSION['MM_Username'] . "'";
 $sql3 = "SELECT regi.branch2 FROM regi WHERE Roll_12 = '" . $_SESSION['MM_Username'] . "'";
 $result6 = mysql_query($sql)or die($sql."<br/><br/>".mysql_error());
 $row6 = mysql_fetch_array($result6);
 $result7 = mysql_query($sql1)or die($sql1."<br/><br/>".mysql_error());
 $row7 = mysql_fetch_array($result7);
 $result8 = mysql_query($sql2)or die($sql2."<br/><br/>".mysql_error());
 $row8 = mysql_fetch_array($result8);
 $result9 = mysql_query($sql3)or die($sql3."<br/><br/>".mysql_error());
 $row9 = mysql_fetch_array($result9);
//$row = mysql_fetch_array($result);
 ?></p>
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row6['Candidate_Name']; ?><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Your Rank : <?php echo $row7['rank']; ?>
 <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Your Choice 1 : <?php echo $row8['branch1']; ?>
 <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Your Choice 2 :  <?php echo $row9['branch2']; ?>
 </div>

   <form action="<?php echo $editFormAction; ?>" name="widgetu7489" class="form-grp clearfix colelem" id="widgetu7489" method="POST" enctype="multipart/form-data"><input name="uname" type="hidden" value="<?php echo ($_SESSION['MM_Username']); ?>"><!-- none box -->
    ...
    <div class="fld-grp clearfix grpelem" id="widgetu7492" data-required="true" data-type="radiogroup"><!-- none box -->
     <label class="fld-label actAsDiv clearfix grpelem" id="u7527-4"><!-- content --><span class="actAsPara">Choice 1 :</span></label>
    ...
    <div class="fld-grp clearfix grpelem" id="widgetu7544" data-required="true" data-type="radiogroup"><!-- none box -->
     <label class="fld-label actAsDiv clearfix grpelem" id="u7557-4"><!-- content --><span class="actAsPara">Choice 2 :</span></label>
   ...
   <div class="clearfix colelem" id="u10558"><!-- group -->
    <div class="clearfix grpelem" id="u10562-8"><!-- content -->
     <p><span id="u10562">*** Choose unique branchs among the options given</span></p>
     <p><span id="u10562-3">*** Choices once filled CAN be editted.</span></p>
     <p><span id="u10562-5">*** Choices once submitted CAN be updated.</span></p>
    </div>
   </div>
   <div class="verticalspacer" data-offset-top="703" data-content-above-spacer="702" data-content-below-spacer="147"></div>
